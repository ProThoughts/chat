...
// Database username:
$config['dbConnection']['user'] = 'qachatuser';
// Database password:
$config['dbConnection']['pass'] = 'password';
// Database name:
$config['dbConnection']['name'] = 'qachat';
// Database type:
...
$config['sessionCookieDomain'] = ".gateoverflow.in";
